...
INSERT INTO "new_TimeOffRequest" ("endDate", "hours", "id", "isPaid", "notes", "reason", "startDate", "status", "timeOffType", "userId") SELECT "endDate", "hours", "id", "isPaid", "notes", "reason", "startDate", "status", "timeOffType", "userId" FROM "TimeOffRequest";
